...
$this->widget('bootstrap.widgets.TbNav', array(
    ...
    'items' => array(
            ...
            array('label'=>'<span class="menu-text">' . strtoupper(Yii::t('app', 'Payment')) . '</span>', 'icon'=>'menu-icon fa fa-heart', 'url'=>Yii::app()->urlManager->createUrl('salePayment/index'), 'active'=>$this->id .'/'. $this->action->id=='salePayment/index','visible'=>Yii::app()->user->checkAccess('payment.index')),
            array('label'=>'<span class="menu-text">' . strtoupper(Yii::t('app', 'Supplier Payment')) . '</span>', 'icon'=>'menu-icon fa fa-credit-card', 'url'=>Yii::app()->urlManager->createUrl('receivingPayment/index'), 'active'=>$this->id .'/'. $this->action->id=='receivingPayment/index','visible'=>Yii::app()->user->checkAccess('payment.index')),
            ...
            array('label'=>'<span class="menu-text">'. strtoupper(Yii::t('menu','PIM')) . '</span>', 'icon'=>'menu-icon fa fa-group','url'=>Yii::app()->urlManager->createUrl('client/admin'),
                           ...
                           'items'=>array(
                               array('label'=>Yii::t('menu', 'Customer') , 'icon'=> TbHtml::ICON_USER, 'url'=>Yii::app()->urlManager->createUrl('client/admin'), 'active'=>$this->id =='client',
                               ...
                               array('label'=>Yii::t('menu', 'Employee'), 'icon'=> TbHtml::ICON_USER, 'url'=>Yii::app()->urlManager->createUrl('employee/admin'), 'active'=>$this->id =='employee', //'active'=>$this->id .'/'. $this->action->id=='employee/admin',
                               ...
                               array('label'=>Yii::t('menu','Supplier'), 'icon'=> TbHtml::ICON_USER, 'url'=>Yii::app()->urlManager->createUrl('supplier/admin'), 'active'=>$this->id == 'supplier',
